...
struct Analyzer {
  ...
  private:
    ...
    void open_scope()                                           { PANIC("not implemented."); }
    void close_scope()                                          { PANIC("not implemented."); }
    void add_node(ASTNode* node)                                { PANIC("not implemented."); }
    void add_namespace(ASTNode* node)                           { PANIC("not implemented."); }
    [[nodiscard]] ASTNode* find_node(std::string_view var_name) { PANIC("not implemented."); }
};
