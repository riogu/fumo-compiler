; ModuleID = 'src/tests/structs-and-postfix/container.fm'
...
define void @"fumo.init.for: src/tests/structs-and-postfix/container.fm"() #0 {
  ret void
}
...
define i32 @main(i32 %argc, ptr %argv) #0 {
  call void @"fumo.init.for: src/tests/structs-and-postfix/container.fm"()
