...
@.str_error_msg = private unnamed_addr constant [223 x i8] c"-> \1B[38;2;235;67;54m[runtime error]\1B[0m in file 'src/tests/structs-and-postfix/calculator.fm' at line 14:\0A   |     let result: i32 = calc_ptr->double();\0A   |                               ^ found null pointer dereference\0A\0A\00", align 1
...
define void @"fumo.init.for: src/tests/structs-and-postfix/calculator.fm"() #0 {
  ret void
}
...
define i32 @main(i32 %argc, ptr %argv) #0 {
  call void @"fumo.init.for: src/tests/structs-and-postfix/calculator.fm"()
