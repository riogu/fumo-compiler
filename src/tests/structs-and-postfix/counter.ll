...
define void @"fumo.init.for: src/tests/structs-and-postfix/counter.fm"() local_unnamed_addr #2 {
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @"counter::increment"(ptr nocapture %0) local_unnamed_addr #3 {
...
define i32 @"counter::get_count"(ptr nocapture readonly %0) local_unnamed_addr #4 {
  %2 = load i32, ptr %0, align 4
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @"counter::get_count_ptr"(ptr readnone returned %0) local_unnamed_addr #5 {
  ret ptr %0
}
