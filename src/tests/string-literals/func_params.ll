; ModuleID = 'src/tests/string-literals/func_params.fm'
...
define void @"fumo.init.for: src/tests/string-literals/func_params.fm"() local_unnamed_addr #1 {
  ret void
}

; Function Attrs: nofree nounwind
define void @print_greeting(ptr %0) local_unnamed_addr #0 {
  %2 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str, ptr %0)
  ret void
}

; Function Attrs: nofree nounwind
define noundef i32 @main(i32 %argc, ptr nocapture readnone %argv) local_unnamed_addr #2 {
  %1 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str, ptr nonnull @.str.1)
  ret i32 0
}
