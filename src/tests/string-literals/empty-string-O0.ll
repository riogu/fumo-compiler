; ModuleID = 'src/tests/string-literals/empty-string.fm'
...
define void @"fumo.init.for: src/tests/string-literals/empty-string.fm"() #0 {
  ret void
}
...
define i32 @main(i32 %argc, ptr %argv) #0 {
  call void @"fumo.init.for: src/tests/string-literals/empty-string.fm"()
