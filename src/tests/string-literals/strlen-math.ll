...
define void @"fumo.init.for: src/tests/string-literals/strlen-math.fm"() local_unnamed_addr #1 {
  ret void
}

; Function Attrs: nofree nounwind
define noundef i32 @main(i32 %argc, ptr nocapture readnone %argv) local_unnamed_addr #2 {
  %1 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.1, ptr nonnull @.str, i32 0)
  ret i32 0
}
