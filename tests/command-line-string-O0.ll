...
@.str = private unnamed_addr constant [217 x i8] c"-> \1B[38;2;235;67;54m[runtime error]\1B[0m in file 'command-line-string.fm' at line 16:\0A   |     return node1.get_next()->get_next()->get_next()->value;\0A   |                            ^ found null pointer dereference\0A\0A\00", align 1
@.str.1 = private unnamed_addr constant [229 x i8] c"-> \1B[38;2;235;67;54m[runtime error]\1B[0m in file 'command-line-string.fm' at line 16:\0A   |     return node1.get_next()->get_next()->get_next()->value;\0A   |                                        ^ found null pointer dereference\0A\0A\00", align 1
@.str.2 = private unnamed_addr constant [241 x i8] c"-> \1B[38;2;235;67;54m[runtime error]\1B[0m in file 'command-line-string.fm' at line 16:\0A   |     return node1.get_next()->get_next()->get_next()->value;\0A   |                                                    ^ found null pointer dereference\0A\0A\00", align 1
...
null_trap:                                        ; preds = %0
  call void @fumo.runtime_error(ptr @.str)
  unreachable
...
null_trap1:                                       ; preds = %safe_deref
  call void @fumo.runtime_error(ptr @.str.1)
  unreachable
...
null_trap4:                                       ; preds = %safe_deref2
  call void @fumo.runtime_error(ptr @.str.2)
  unreachable
